...
def _deal_card(frame):
    # pop the next card form the deck
    next_card = deck.pop(0)
    # and add it to the bottom of the pack
...
def new_game():
    ...
    # Create the list to store dealers and payers hands
    dealer_hand = []
    player_hand = []
    initial_deal()
...
# these two can be deleted. They don't need to be global vars now.
# player_score = 0
# player_ace = False
...
Stick_button = tkinter.Button(button_frame, text="Stick", command=deal_dealer)
Stick_button.grid(row=0, column=0, )
